...
%global pkg_name autoware_lint_common
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-rolling-autoware-lint-common
Version:        1.4.0
Release:        1%{?dist}
...
* Fri May 01 2026 Ryohsuke Mitsudome <ryohsuke.mitsudome@tier4.jp> - 1.2.0-1
- Autogenerated by Bloom

* Tue Apr 28 2026 Ryohsuke Mitsudome <ryohsuke.mitsudome@tier4.jp> - 1.1.0-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Ryohsuke Mitsudome <ryohsuke.mitsudome@tier4.jp> - 1.1.0-1
- Autogenerated by Bloom
